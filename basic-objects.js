 ...
 */
 ...
 function street2(length, heigth, top_length){
   var l_2 = length/2.0;
   var h_2 = heigth/2.0;
   var top_2 = top_length/2.0;
   var bot_off = length * 0.15;
   var coords = [
...
function street(length, heigth, top_length){
  var l_2 = length/2.0;
  var h_2 = heigth/2.0;
  var top_2 = top_length/2.0;
  var coords = [
    -l_2, -h_2, 0.0,
    -top_2, h_2, 0.0,
    0.0, -h_2,0.0, //first triangle
    top_2, h_2, 0.0,
    l_2, -h_2, 0.0
  ];

  var indices = [0,1,2,3,2,1,2,3,4];
  var normals = [];
  for(var i = 0; i < coords.length/3;i++){
    normals.push(0,0,1);
  }
